  ...
  [
    ...
    theoryStep(
      ...
      [
        ...
        section('categorical-values', 'Тариф пока остаётся строкой', [
          '`tariff` остаётся со значениями `basic` — «базовый» и `pro` — «расширенный». Преобразование категорий в числа разбирается позже, в теме 4.16.',
        ]),
      ],
    ),
    theoryStep(
    ...
    practiceStep(
      ...
      makeStdinTask(
        ...
        `,
        [
          { id: 's1', description: 'Квартиры: area — площадь, rooms — комнаты, district — район, price — цена', input: 'area rooms district price\nprice', expectedOutput: 'area rooms district' },
