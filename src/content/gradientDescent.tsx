    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="text-sm text-gray-700">
          Для этой квадратичной функции L(θ) = (θ−3)² коэффициент сходимости составляет (1−2α)² = 0.64 за шаг.
          За 10 шагов: L снижается с 9.0 до 0.046. Это частный случай — для общих функций скорость сходимости
          определяется обусловленностью матрицы Гессиана.
        </p>
      </section>
